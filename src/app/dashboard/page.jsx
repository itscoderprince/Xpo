        ...
        <main className="min-h-screen bg-navy-950">
            ...
            <div className="max-w-7xl mx-auto px-6 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                    {[
                        { label: "Total Balance", value: "$45,250.00", change: "+12.5%", icon: Wallet, color: "blue" },
                        { label: "Total Profit", value: "$8,350.00", change: "+8.2%", icon: TrendingUp, color: "emerald" },
                        { label: "Active Investments", value: "12", change: "+2", icon: LayoutDashboard, color: "purple" },
                        { label: "Monthly Returns", value: "4.8%", change: "+0.3%", icon: TrendingUp, color: "amber" },
                    ].map((stat, i) => (
                        <motion.div
                            key={i}
                            initial={{ opacity: 0, y: 20 }}
                ...
                <div className="flex flex-wrap gap-4 mb-12">
                    ...
                    <button className="px-6 py-3 bg-white/5 hover:bg-white/10 text-white font-bold rounded-xl border border-white/10 transition-colors">
                        View Portfolio
                    </button>
                    <button
                ...
                <div className="bg-navy-900/50 border border-white/5 rounded-2xl p-12 text-center">
                    ...
                    <h2 className="text-xl font-bold text-white mb-2">Dashboard Under Construction</h2>
                    <p className="text-slate-400 max-w-md mx-auto">
                        Your personalized investment dashboard is being built. Check back soon for real-time analytics, portfolio management, and more.
                    </p>
                </div>
            </div>
